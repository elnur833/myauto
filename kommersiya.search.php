        ...
        <section class="full car_search_section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h2 class="search_panel_title">Kommersiya</h2>
                    </div>
                                ...
                                <div class="advanced_search_container full">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pl-0 motor_types">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label >
                                                    ...
                                                    <div class="col-md-4 pl-0">
                                                        <label >
                                                            <input type="radio" name="motor" value="1" checked>
                                                            <p>1 - 1.5 t. qədər</p>
                                                        </label>
                                                    </div>
                                ...
                                <div class="advanced_search_container full">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pr-0 motor_types">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label >
                                                            <input type="radio" name="motor" value="1" >
