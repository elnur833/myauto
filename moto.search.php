        ...
        <section class="full car_search_section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h2 class="search_panel_title">Moto</h2>
                    </div>
                    ...
                    <div class="col-md-12 ">
                        <div class="search_panel">
                            ...
                            <div class="col-md-5 moto_cats" >
								<div class="row">
									<div class="col-lg-3 col-md-4 active">
										<a href="#moto" >Moto</a>
									</div>
									<div class="col-lg-3 col-md-4">
										<a href="#skuter">Skuter</a>
									</div>
									<div class="col-lg-3 col-md-4 ">
										<a href="#kvadrosikl">Kvadrosikl</a>
									</div>
								</div>
								</div>
                            </div>
                            ...
                            <!---->
                            <!-- moto kommersiya-->
                            <div id="moto" class="elan_yerlesdir_forms active">
                            <form class="full">
                                <!---->
                            ...
                            <!-- skuter kommersiya-->
                            <div id="skuter" class="elan_yerlesdir_forms">
                            <form class="full">
                                <!---->
                                <div class="col-md-12 main_filters">
                                    <div class="row">
                                            ...
                                            <div class="col-md-12 specs_checkbox">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label>
                                                            <input type="checkbox" class="form-control">
                                                            <p>Küləyə qarşı şüşə</p>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label>
                                                            <input type="checkbox" class="form-control">
                                                            <p>"Start-stop" sistemi</p>
                                                        </label>
                                                    </div>
                            ...
                            <!-- kvadrosikl kommersiya-->
                            <div id="kvadrosikl" class="elan_yerlesdir_forms">
                            <form class="full">
                                <!---->
                                <div class="col-md-12 main_filters">
                                    <div class="row">
