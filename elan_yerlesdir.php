                          ...
                          <div class="col-md-12">
                            <div class="row">
                              ...
                              <div class="col-md-3 pl-0 from_to">
                                <div class="form-group align-center has-error">
									<input type="text" class="form-control floating-input" name="" placeholder=" ">
						  				...
						  				<div class="col-md-12">
						  					<div class="row">
											  	<div class="uploaded_img">
													  ...
													  <button class="delete_uploaded"></button>
													  <img src="assets/images/uploaded1.png" alt="">
												</div>
												<div class="uploaded_img">
													  <button class="rotate"></button>
													  <button class="delete_uploaded"></button>
												...
												<div class="uploaded_img">
													  <button class="rotate"></button>
													  <button class="delete_uploaded"></button>
													  <img src="assets/images/up3.png" alt="">
												</div>
												<div class="uploaded_img">
													  <button class="rotate"></button>
													  <button class="delete_uploaded"></button>
													  <img src="assets/images/up4.png" alt="">
												</div>
